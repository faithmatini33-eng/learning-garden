...
| `js/coach.js` | school-focus sync (`SKILL_KEYWORDS`), diagnostics ("Garden Checkup"), Daily Mix, Socratic math tutor + solo transfer step, word-problem wizard, Word Helper, parent report |
...
- Emoji are for **characters only** (avatars, fox 🦊, owl 🦉); all UI chrome uses inline Lucide SVGs.
